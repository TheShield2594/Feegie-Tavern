...
export const VILLAGERS: VillagerDef[] = [
  {
    ...
    schedule: [
      ...
      { from: 14, at: 'shop.front', label: 'Errands', activity: 'browse' },
  ...
  },
  {
    ...
    schedule: [
      ...
      { from: 13, at: 'beach.dunes', label: 'Walking the dunes', activity: 'walk' },
  ...
  },
  {
    ...
    schedule: [
      ...
      { from: 13, at: 'museum.steps', label: 'Airing out', activity: 'walk' },
